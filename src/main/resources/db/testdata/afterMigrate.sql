...
(1, 'João da Silva', 'joao.ger@algafood.com', '$2a$12$/e2uYftHk9SbUqePnXa84ucvL1XTySV9Z1zMQfNZKtAXC/CXg4oDS', utc_timestamp),
(2, 'Maria Joaquina', 'maria.vnd@algafood.com', '$2a$12$/e2uYftHk9SbUqePnXa84ucvL1XTySV9Z1zMQfNZKtAXC/CXg4oDS', utc_timestamp),
(3, 'José Souza', 'jose.aux@algafood.com', '$2a$12$/e2uYftHk9SbUqePnXa84ucvL1XTySV9Z1zMQfNZKtAXC/CXg4oDS', utc_timestamp),
(4, 'Sebastião Martins', 'sebastiao.cad@algafood.com', '$2a$12$/e2uYftHk9SbUqePnXa84ucvL1XTySV9Z1zMQfNZKtAXC/CXg4oDS', utc_timestamp),
(5, 'Manoel Lima', 'manoel.loja@gmail.com', '$2a$12$/e2uYftHk9SbUqePnXa84ucvL1XTySV9Z1zMQfNZKtAXC/CXg4oDS', utc_timestamp),
(6, 'Débora Mendonça', 'marquinhofalves+debora@gmail.com', '$2a$12$/e2uYftHk9SbUqePnXa84ucvL1XTySV9Z1zMQfNZKtAXC/CXg4oDS', utc_timestamp),
(7, 'Carlos Lima', 'marquinhofalves+carlos@gmail.com', '$2a$12$/e2uYftHk9SbUqePnXa84ucvL1XTySV9Z1zMQfNZKtAXC/CXg4oDS', utc_timestamp);
...
VALUES('1', 'algafood-backend', '2023-03-31 10:20:25', '$2a$10$olaezZrxYNIvygEYyV8.HOQCIGC6Iew1Tl1iYCdQVf9tT0TdGo9S2', NULL, '1', 'client_secret_basic', 'client_credentials', '', NULL, 'READ', '{"@class":"java.util.Collections$UnmodifiableMap","settings.client.require-proof-key":false,"settings.client.require-authorization-consent":false}', '{"@class":"java.util.Collections$UnmodifiableMap","settings.token.reuse-refresh-tokens":true,"settings.token.id-token-signature-algorithm":["org.springframework.security.oauth2.jose.jws.SignatureAlgorithm","RS256"],"settings.token.access-token-time-to-live":["java.time.Duration",86400.000000000],"settings.token.access-token-format":{"@class":"org.springframework.security.oauth2.server.authorization.settings.OAuth2TokenFormat","value":"self-contained"},"settings.token.refresh-token-time-to-live":["java.time.Duration",172800.000000000],"settings.token.authorization-code-time-to-live":["java.time.Duration",300.000000000]}');

INSERT INTO oauth2_registered_client
(id, client_id, client_id_issued_at, client_secret, client_secret_expires_at, client_name, client_authentication_methods, authorization_grant_types, redirect_uris, post_logout_redirect_uris, scopes, client_settings, token_settings)
VALUES('2', 'algafood-web', '2023-03-31 10:20:25', '$2a$10$JLfonl17uT5/NMrcitCmAubstM/Kkb644MQt0GwcjmNpKnRliftfe', NULL, '2', 'client_secret_basic', 'refresh_token,authorization_code', 'http://127.0.0.1:8081/authorized,http://127.0.0.1:8081/swagger-ui/oauth2-redirect.html,http://127.0.0.1/swagger-ui/oauth2-redirect.html', NULL, 'READ,WRITE', '{"@class":"java.util.Collections$UnmodifiableMap","settings.client.require-proof-key":false,"settings.client.require-authorization-consent":true}', '{"@class":"java.util.Collections$UnmodifiableMap","settings.token.reuse-refresh-tokens":false,"settings.token.id-token-signature-algorithm":["org.springframework.security.oauth2.jose.jws.SignatureAlgorithm","RS256"],"settings.token.access-token-time-to-live":["java.time.Duration",86400.000000000],"settings.token.access-token-format":{"@class":"org.springframework.security.oauth2.server.authorization.settings.OAuth2TokenFormat","value":"self-contained"},"settings.token.refresh-token-time-to-live":["java.time.Duration",172800.000000000],"settings.token.authorization-code-time-to-live":["java.time.Duration",300.000000000]}');

INSERT INTO oauth2_registered_client
(id, client_id, client_id_issued_at, client_secret, client_secret_expires_at, client_name, client_authentication_methods, authorization_grant_types, redirect_uris, post_logout_redirect_uris, scopes, client_settings, token_settings)
VALUES('3', 'foodanalytics', '2023-03-31 10:20:25', '$2a$10$cVfWArhR.mq5dAN.JnsWK.haD9O1Ca87SOlu3JDwqrXVR8WfMRcUq', NULL, '3', 'client_secret_basic', 'authorization_code', 'http://www.foodanalytics.local:3001', NULL, 'READ,WRITE', '{"@class":"java.util.Collections$UnmodifiableMap","settings.client.require-proof-key":false,"settings.client.require-authorization-consent":false}', '{"@class":"java.util.Collections$UnmodifiableMap","settings.token.reuse-refresh-tokens":true,"settings.token.id-token-signature-algorithm":["org.springframework.security.oauth2.jose.jws.SignatureAlgorithm","RS256"],"settings.token.access-token-time-to-live":["java.time.Duration",86400.000000000],"settings.token.access-token-format":{"@class":"org.springframework.security.oauth2.server.authorization.settings.OAuth2TokenFormat","value":"self-contained"},"settings.token.refresh-token-time-to-live":["java.time.Duration",172800.000000000],"settings.token.authorization-code-time-to-live":["java.time.Duration",300.000000000]}');
